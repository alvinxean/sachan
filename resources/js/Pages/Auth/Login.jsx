            ...
            <form onSubmit={submit}>
                ...
                <div>
                    ...
                    <TextInput
                        ...
                        value={data.identity_number} // Pastikan di 'useForm' gunakan key ini
                        className="mt-1 block w-full uppercase"
                        maxLength={30}
                        isFocused={true}
                        onChange={(e) => {
                            // 1. .toUpperCase() mengubah huruf kecil jadi besar
                            // 2. .replace(/\s/g, '') menghapus semua spasi
                ...
                <div className="mt-4">
                    ...
                    <TextInput
                        ...
                        name="phone_number"
                        value={data.phone_number} // Pastikan di 'useForm' gunakan key ini
                        className="mt-1 block w-full"
                        maxLength={15}
                        inputMode="numeric" // <-- Tambahkan ini agar keyboard HP otomatis jadi angka
                        pattern="[0-9]*"    // Validasi HTML dasar agar hanya angka
                        onChange={(e) => {
                            // Ini kuncinya: membuang karakter apa pun yang BUKAN angka (0-9)
                ...
                {/* Tombol Login dengan Spinner Bawaan Tailwind */}
                <div className="mt-4 flex items-center justify-end">
                    <PrimaryButton className="ms-4" disabled={processing}>
                        {processing && (
                            // Spinner SVG Bawaan Tailwind
