            ...
            <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div className="p-8 md:p-12">
                    ...
                    {/* <div className="flex gap-4 border-b pb-4 mb-8">
                        <Link href="/privacy-policy" className="bg-slate-900 text-white px-6 py-2 rounded-lg font-semibold">Kebijakan Privasi</Link>
                        <Link href="/terms-of-service" className="text-slate-500 hover:text-slate-800 px-6 py-2 font-semibold">Syarat & Ketentuan</Link>
                    </div> */}
